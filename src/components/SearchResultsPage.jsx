  ...
  return (
    <>
      ...
      <div className={`all-body${darkMode}`}>
        <div className={`search-results-body${darkMode}`}>
          <h1>{language === "es-ES" ? "Resultados" : "Results:"}</h1>
          <p>Showing results for: {searchKey}</p>

          <div>
            <ul className={`search-results-list${darkMode}`}>
              {searchResults.map((result) =>
                result.known_for ? (
                  <li key={result.id}>
                    <h3>{result.name}</h3>
                    <div className={`search-results-info${darkMode}`}>
                  ...
                  <li key={result.id}>
                    ...
                    <div className={`search-results-info${darkMode}`}>
                      ...
                      <div className={`seacrh-results-text${darkMode}`}>
                        <p>
                          {language === "es-ES"
                            ? "Fecha de estreno:"
                            : "Release date:"}{" "}
