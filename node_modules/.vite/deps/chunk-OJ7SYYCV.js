...
var React, import_prop_types, import_jsx_runtime, _excluded, styles;
...
var React4, import_prop_types2, import_jsx_runtime4, _excluded2, useUtilityClasses, TabScrollButtonRoot, TabScrollButton, TabScrollButton_default;
...
var React5, import_react_is, import_prop_types3, import_jsx_runtime5, import_jsx_runtime6, _excluded3, nextItem, previousItem, moveFocus, useUtilityClasses2, TabsRoot, TabsScroller, FlexContainer, TabsIndicator, TabsScrollbarSize, defaultIndicatorStyle, warnedOnceTabPresent, Tabs, Tabs_default;
var init_Tabs = __esm({
  "node_modules/@mui/material/Tabs/Tabs.js"() {
    "use client";
    init_objectWithoutPropertiesLoose();
    ...
    _excluded3 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
    nextItem = (list, item) => {
      if (list === item) {
    ...
    Tabs = React5.forwardRef(function Tabs2(inProps, ref) {
      const props = useThemeProps({
        props: inProps,
        name: "MuiTabs"
      });
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OJ7SYYCV.js.map
